...
import {TaskAPIType, TaskPriorities, TaskStatuses, TaskUpdateAPIType, todolistsAPI} from "../api/todolistsAPI";
...
//     return (dispatch: Dispatch) => {
//         todolistsAPI.updateTask(todolistId, taskId, {status: status})
//             .then(response => {
